    ...
    public class ProductService : IProductService
    {
        ...
        public async Task<ProductResponseModel> GetProductByIdAsync(Guid productId)
        {
            ...
            return new ProductResponseModel
            {
                ...
                SellerProduct = _mapper.Map<DTOs.ProductSellerDTO>(product)
            };
        }
        ...
        public async Task<ProductResponseModel> GetProductsByStoreAsync(Guid storeId, ClaimsPrincipal user)
        {
            ...
            if (roleClaim == "seller")
            {
                return new ProductResponseModel
                {
                    Success = true,
                    Message = OperationResult.Success,
                    SellerProductList = _mapper.Map<IEnumerable<DTOs.ProductSellerDTO>>(products)
                };
            }
            ...
            return new ProductResponseModel
            {
                Success = true,
                Message = OperationResult.Success,
                BuyerProductList = _mapper.Map<IEnumerable<DTOs.ProductBuyerDTO>>(products)
            };
        }
        ...
        public async Task<ProductResponseModel> CreateProductAsync(DTOs.ProductDTO dto)
        {
        ...
        // Category
        //---------------------------
        public async Task<ProductResponseModel> CreateCategoryAsync(DTOs.CategoryDTO category)
        {
            try
            {
                ...
                return new ProductResponseModel
                {
                    Success = true,
                    Message = OperationResult.Success,
                    CategoryInfo = _mapper.Map<DTOs.CategoryDTO>(newCategory)
                };
            }
            catch (Exception ex)
            {
        ...
        public async Task<ProductResponseModel> SearchCategoriesAsync(Guid storeId)
        {
            ...
            return new ProductResponseModel
            {
                Success = true,
                Message = OperationResult.Success,
                CategoryList = _mapper.Map<IEnumerable<DTOs.CategoryDTO>>(categories)
            };
        }
    }
}
